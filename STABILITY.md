...
| S7 | P1 | No GPU-overload guard on local pulls; no accel hint | **Fixed** — one pull at a time; refuse all pulls when critical; refuse 14B+ when elevated; prefer smaller recs; NVIDIA/AMD/Intel driver hints (no fake installer) |
