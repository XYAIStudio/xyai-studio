...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      title: 'XYAI Studio and DSH Joint Internal Testing Notice',
      body: "XYAI Studio and DeepSeek Harness (DSH) are currently in joint internal testing for developers. The desktop integration, Harness capabilities, XYOS business space, and local model workflows are still being improved, and we welcome feedback from the developer community.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, reusable, and composable infrastructure. Welcome to the XYAI Studio and DSH joint internal testing program.",
