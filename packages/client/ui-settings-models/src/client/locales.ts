...
export const en = {
  ...
  creating: 'Creating\u2026',
  welcomeTitle: 'XYAI Studio and DSH Joint Internal Testing Notice',
  welcomeBody: "XYAI Studio and DeepSeek Harness (DSH) are currently in joint internal testing for developers. The desktop integration, Harness capabilities, XYOS business space, and local model workflows are still being improved, and we welcome feedback from the developer community.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, reusable, and composable infrastructure. Welcome to the XYAI Studio and DSH joint internal testing program.",
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  create: '创建提供方',
  creating: '创建中\u2026',
  welcomeTitle: 'XYAI Studio 与 DSH 联合内测声明',
  welcomeBody: 'XYAI Studio 与 DeepSeek Harness（DSH）目前面向开发者进行联合内测。桌面端集成、Harness 能力、XYOS 业务空间和本地模型工作流仍在持续改进和打磨，欢迎广大开发者反馈使用体验。\n\n我们期待与全球开发者一起，在开源、可复用、可组合的基础设施之上，共同探索智能上限。欢迎加入 XYAI Studio 与 DSH 联合内测计划。',
  welcomeContinue: '继续',
