...
// The XYAI base product bundle ships inside the seed: the closure rooted here
// pulls the XYAI plugin packages out of the packed XYAI input directory.
const XYAI_ROOT_PACKAGES = ['@xyai/dsh-product-base', '@xyai/dsh-product-collab'] as const
const ROOT_PACKAGES = [DSH_PACKAGE, DESKTOP_HOST_PACKAGE, ...XYAI_ROOT_PACKAGES] as const
